    ...
    var b, c = "function" == typeof define && define.amd, d = function (b) {
        ...
        options: {
            ...
            onCreateLink: function (a) {
                return -1 !== a.indexOf("@") && -1 === a.indexOf(":") ? a = "mailto:" + a : -1 === a.indexOf("://") && (a = "https://" + a), a
            },
            keyMap: {
                pc: {
        ...
        var b = function (a, b) {
            ...
            var f = function () {
                var b = c("fa fa-edit", {
                    ...
                    title: a.link.unlink,
                    event: "unlink"
                }), f = '<a href="https://www.google.com" target="_blank">www.google.com</a>&nbsp;&nbsp;<div class="note-insert btn-group">' + b + e + "</div>";
